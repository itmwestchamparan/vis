    ...
    try {
        ...
        for (const column of requiredColumns) {
            if (!(column in firstRow)) {
                showUploadStatus(`Required column '${column}' is missing in the Excel file.`, 'status-error');
                return;
            }
        }
        ...
        showUploadStatus('Error processing the Excel data. Please check the format.', 'status-error');
    }
}
